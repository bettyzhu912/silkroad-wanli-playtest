...
const ORDER = ['assets.js', 'data.js', 'inn-data.js', 'commission-data.js', 'help-data.js', 'model.js', 'time.js', 'reputation.js', 'store.js', 'inventory.js', 'pricing.js', 'market.js', 'finance.js', 'merchant.js', 'minigames.js', 'caravan-engine.js', 'caravan.js', 'tavern.js', 'events.js', 'inn.js', 'commissions.js', 'stories.js', 'observations.js', 'trip.js', 'time-risk.js', 'newspapers.js', 'tutorial.js', 'journey-controller.js'];
