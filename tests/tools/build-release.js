...
const runtimeFiles = tracked.filter(f => !f.startsWith('tests/') && !f.startsWith('weaving-demo/') && !f.startsWith('weaving-v5/') && !f.startsWith('caravan-demo/') && !f.startsWith('pattern-chain/') && !f.startsWith('tod-prototype/') && !f.startsWith('.claude/') && !f.startsWith('.github/') && f !== '.gitignore');
