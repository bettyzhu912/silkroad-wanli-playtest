...
test('LV-B3', '缀纹成章工钱（TEMP_CASH_MAPPING_v0）：0 有效笔 → 0；有效笔 ≥ 1 → 5 + ⌊score/6⌋ 夹在 [6, 15]（冻结的 HALF_DAY 上下限）', () => {
  ...
  assert(S.patternChain.RULES.cashMapping === 'TEMP_CASH_MAPPING_v0' && S.patternChain.RULES.ticks === 1, 'rules tagged');
