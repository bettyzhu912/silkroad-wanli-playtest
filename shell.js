(function (S) {
  ...
  function renderHUD() {
    ...
    // HUD_POLISH_CORRECTION_v0.2: right slot = time icon (×1.15) + three rows — 年份 (regular, lowest weight) / 月日 · 时辰 (时辰 bold) / 商期　未启程 | 商期　N日 / 22日 (numbers bold, +1 px). Real runtime calendar labels (S.time.calendar).
